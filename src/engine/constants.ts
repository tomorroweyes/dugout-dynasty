export const GAME_CONSTANTS = {
  ...
  AT_BAT: {
    ...
    STRIKEOUT_DIVISOR: 2.0, // Lower = more strikeouts. Target ~32-35% K for balanced matchups
    ...
    TRIPLE_THRESHOLD: 95,
    DOUBLE_THRESHOLD: 85,
    SINGLE_THRESHOLD: 62,  // Raised from 55 — reduces hit rate on BIP from ~30% to ~23%
